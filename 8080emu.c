...
void Emulate8080Op(State8080 *state){
	...
	switch(*code){
		...
		case 0x2E: printf("MVI L, $%02X", code[1]); opLength = 2; break;
		...
		case 0x3E: printf("MVI A, $%02X", code[1]); opLength = 2; break;
		...
		case 0xC6: printf("ADI $%02X", code[1]); opLength = 2; break;
		...
		case 0xD3: printf("OUT $%02X", code[1]); opLength = 2; break;
		...
		case 0xE2: printf("JPO $%02X%02X", code[2], code[1]); opLength = 3; break;
		case 0xE3: printf("XHTL");	break;
		case 0xE4: printf("CPO $%02X%02X", code[2], code[1]); opLength = 3; break;
		case 0xE5: printf("PUSH H");	break;
		case 0xE6: printf("ANI $%02X", code[1]); opLength = 2; break;
		...
		case 0xF6: printf("ORI $%02X", code[1]); opLength = 2; break;
